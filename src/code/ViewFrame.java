...
public class ViewFrame extends JFrame{
	...
	private static final String PENCIL_TOOL = null;
	// 定义业务逻辑类
	...
	ActionListener menuListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			service.menuDo(ViewFrame.this, e.getActionCommand());
		}
	};
	// 默认JScrollPane
	...
	public void init() {
		...
		// 设置标题
		// 获取正在使用的工具
		tool = (Tool) ToolFactory.getToolInstance(this, PENCIL_TOOL);

		// 创建鼠标运动监听器
		MouseMotionListener motionListener = new MouseMotionAdapter() {
			// 拖动鼠标
			public void mouseDragged(MouseEvent e) {
				((code.Tool.Tool) tool).mouseDragged(e);
			}

			// 移动鼠标
			public void mouseMoved(MouseEvent e) {
				((code.Tool.Tool) tool).mouseMoved(e);
			}
		...
		MouseListener mouseListener = new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				  ((code.Tool.Tool) tool).mouseReleased(e);
			}

			// 按下鼠标
			public void mousePressed(MouseEvent e) {
				 ((code.Tool.Tool) tool).mousePressed(e);
			}

			// 点击鼠标
			public void mouseClicked(MouseEvent e) {
				 ((code.Tool.Tool) tool).mouseClicked(e);
			}
		};
	...
	public JPanel createToolPanel() {
		...
		// 工具数组
		String[] toolarr = { "PencilTool", "BrushTool", "ColorPickedTool",
				"AtomizerTool", "EraserTool", "LineTool", "PolygonTool", "RectTool",
				"RoundTool", "RoundRectTool" };
